...
export default class Editor extends Component {
  ...
  addNewQr = () => {
    ...
    let newQrObj = Object.assign({}, this.state.newQrObj);
    console.log(newQrObj)
    newQrObj.id = Math.round(Math.random() * 10000);
    let selectedObject = newQrObj;
    console.log(selectedObject)
    arrayObjectsLayer.push(newQrObj);
     ...
     {this.state.selectQr === "4" &&
        ...
        <div className="containerCanvas" ref={this.containerCanvas}>
          <div className="containerToolbar">
            ...
            <div className="containerIconeToolbar" onClick={this.addNewQr}>
       <img className="img" src={"qr"} title="qr"></img>
     </div>
            ...
            <div className="containerIconeToolbar" onClick={this.addNewSquare}>
              <img className="img" src={Rectangle} title="Square"></img>
            </div>
            <div className="containerIconeToolbar" onClick={this.addNewTriangle}>
              <img className="img" src={Triangule} title="Triangulo"></img>
            </div>
            <div className="containerIconeToolbar" onClick={this.addNewRectangle}>
            <img className="img" src={Rectangle} title="Retangulo"></img>
          </div>
          <div className="containerIconeToolbar" onClick={this.addNewLine}>
          <img className="img" src={""} title="Line" alt="lin"></img>
        </div>
        <div className="containerIconeToolbar" onClick={this.addNewArrow}>
        <img className="img" src={""} title="Arrow" alt="arow"></img>
      </div>
...
{showPallet && (
   ...
   {/**BOLD */}
      ...
      />
       ...
       {/***Lowe case Text Transform */}
    <div
    className="containerIconeToolbar"
    onClick={() =>
      this.setTextTransformLowercase(
        arrayObjectsLayer[indexTextSelected] &&
          arrayObjectsLayer[indexTextSelected].textTransform == "lowercase"
          ? ""
          : "lowercase"
...
<img className="img" src={Underline} title="Sublinhado"></img>
 ...
 {/*** CAPITALIZE case Text Transform */}
<div
className="containerIconeToolbar"
onClick={() =>
...
{/**text align left */}
  ...
  onClick={() =>
    this.setTextAlignJustify(
      arrayObjectsLayer[indexTextSelected] &&
        arrayObjectsLayer[indexTextSelected].textJustify == "inter-word"
        ? ""
        : "inter-word"
    )
  }
            ...
            <div className={`container-area`}>
              ...
              >
                <Layer>
                  ...
                  <Group ref={this.groupRef} draggable x={50} y={220}>
               ...
               isSelected={
                  ...
                  <Rect width={265} height={265} fill="" />
                </Group>
