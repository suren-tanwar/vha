...
//      <div className='navbar-div-saved-card-image'    onClick={()=>this.saveEverything()}>
...
// </div>
//  {/*****two buttons*/}
//   <div className='front-image-button'>
//   <div className='front-new-image-button'>
//   <span className='front-new-text-image-button'>Front Side</span>
//   </div>
//   <div className='back-button' onClick={()=> this.props.history.push("/horizontal-card-back")}>
//   <span className='back-template-image-button'>Back Side</span>
//   </div>
//   </div>
...
// <Layer>
// {/****
// {   this.state.rectangles && this.state.rectangles.map((rect, i) => {
//   return (
//    <Transformtext
//       key={i}
//       shapeProps={rect}
